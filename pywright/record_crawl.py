...
async def fetch_table(playwright, idx, url):
    ...
    # away_team = await page.locator('#content > div > div.Home_main_section__y9jR4 > section.Home_game_panel__97L_8 > div.Home_game_contents__35IMT > div > div.PlayerRecord_comp_player_record__1tI5G.type_kbo > div.PlayerRecord_tab_area__1oYK_ > div > button:nth-child(2) > strong').text_content()
    #     # print(aa)
    # df1['상대팀'] = away_team
